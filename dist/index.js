...
function setupSmtpService() {
  try {
    ...
    console.log("\u2705 SMTP STABLESERVER - kevin@monelec.net \u2192 bonjour@portail-electricite.com");
  } catch (error) {
...
async function registerRoutes(app2) {
  ...
  console.log("Service SMTP configur\xE9 - kevin@monelec.net \u2192 bonjour@portail-electricite.com");
  ...
  app2.get("/api/admin/notification-email", requireAuth, requireAdmin, async (req, res) => {
    try {
      ...
      const standardEmails = ["bonjour@portail-electricite.com"];
      ...
      if (notificationEmails.length === 0) {
        notificationEmails = ["bonjour@portail-electricite.com"];
      }
      res.status(200).json({
        success: true,
        data: {
