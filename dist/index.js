...
async function createImapConfigFromUser(userId) {
  try {
    if (userId === 1) {
      ...
      if (!adminPassword) {
        ...
        return {
          ...
          useSimulatedBoxes: true
          // Use simulated mode for security
        };
      }
      return {
        user: "contact@portail-electricite.com",
    ...
    console.log(`Pas de configuration d'environnement pour l'utilisateur ${userId}, utilisation du mode simul\xE9`);
    return {
      user: "contact@portail-electricite.com",
      password: "",
