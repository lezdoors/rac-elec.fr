        ...
        <div className="container max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-lg p-8 relative overflow-hidden">
            ...
            <div className="prose prose-blue max-w-none">
              ...
              <p>
                Le site demande-raccordement.fr est hébergé par MochaHost (MochaHost LLC, 7365 Carnelian St. Suite 203, Rancho Cucamonga, CA 91730, États-Unis).
              </p>
              ...
              <p>
                Si vous avez des questions concernant notre politique de cookies, veuillez nous contacter à l'adresse suivante : contact@demande-raccordement.fr ou par téléphone au +33 (0) 9 70 70 95 70.
              </p>
            </div>
          </div>
        </div>
