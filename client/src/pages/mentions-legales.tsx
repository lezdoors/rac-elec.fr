  ...
  return (
    <Layout>
      <div id="top" className="min-h-screen bg-gray-50 py-12">
        <Helmet>
          <title>Mentions Légales | Raccordement-Elec.fr</title>
          <meta 
            name="description" 
            content="Mentions légales de Raccordement-Elec.fr, service d'accompagnement pour vos démarches de raccordement électrique." 
          />
          <link rel="canonical" href="https://raccordement-elec.fr/mentions-legales" />
        </Helmet>
        ...
        <div className="container max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-white rounded-lg shadow-lg p-8 relative overflow-hidden">
            ...
            <div className="prose prose-blue max-w-none">
              ...
              <p>
                Le site raccordement-elec.fr est hébergé par :
              ...
              <p>
                Pour demander une modification, rectification ou suppression des données vous concernant, il vous suffit d'envoyer un courrier électronique à l'adresse contact@raccordement-elec.fr.
              </p>
              <p>
              ...
              <p>
                Le site raccordement-elec.fr utilise des cookies pour améliorer l'expérience utilisateur. Pour plus d'informations sur notre utilisation des cookies, veuillez consulter notre <a href="/cookies" className="text-blue-600 hover:text-blue-800 underline">Politique des Cookies</a>.
              </p>
              
              <h2 className="text-xl font-semibold text-blue-700 mt-8 mb-4">7. Limitation de responsabilité</h2>
              <p>
                Les informations contenues sur ce site sont aussi précises que possible et le site est périodiquement mis à jour, mais peut toutefois contenir des inexactitudes, des omissions ou des lacunes. Si vous constatez une erreur ou ce qui peut être une inexactitude, défectuosité ou lacune, merci de bien vouloir le signaler par email à contact@raccordement-elec.fr.
              </p>
              <p>
              ...
              <p>
                Pour toute question relative au site raccordement-elec.fr, vous pouvez nous contacter :
                <br />Par téléphone : +33 (0) 9 70 70 95 70
                <br />Par email : contact@raccordement-elec.fr
              </p>
