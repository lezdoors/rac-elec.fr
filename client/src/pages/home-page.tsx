      ...
      <main>
        ...
        <section className="py-16 bg-white" id="services">
          <div className="container mx-auto px-4 sm:px-6 lg:px-8">
            <div className="max-w-6xl mx-auto">
              <div className="text-center mb-12">
                <p className="text-gray-600 mb-2">Chaque projet est unique. Découvrez la solution électrique adaptée à vos besoins spécifiques.</p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
                  ...
                  <a href="/raccordement-definitif" className="text-blue-600 text-sm font-medium hover:text-blue-700 transition-colors">
                    En savoir plus →
                  </a>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
                  ...
                  <a href="/raccordement-provisoire" className="text-blue-600 text-sm font-medium hover:text-blue-700 transition-colors">
                    En savoir plus →
                  </a>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
                  ...
                  <a href="/viabilisation-terrain" className="text-blue-600 text-sm font-medium hover:text-blue-700 transition-colors">
                    En savoir plus →
                  </a>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg border border-gray-200 hover:shadow-lg transition-shadow">
                  ...
                  <a href="/modification-compteur" className="text-blue-600 text-sm font-medium hover:text-blue-700 transition-colors">
                    En savoir plus →
                  </a>
                </div>
              ...
              <div className="text-center mt-12">
                <p className="text-gray-600 mb-4">
                  Besoin d'aide pour choisir ? Nos experts vous accompagnent dans le choix de la solution la plus adaptée à votre projet.
                </p>
