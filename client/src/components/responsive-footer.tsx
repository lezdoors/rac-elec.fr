      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-7xl">
        ...
        <div className="flex flex-wrap justify-between items-center mt-6 pt-4 border-t border-blue-900/40 text-xs text-gray-400">
          <div className="flex items-center">
            <span className="text-blue-300 font-medium mr-1">©</span> {year} <span className="text-blue-200 font-medium mx-1">demande-raccordement.fr</span> - Tous droits réservés
          </div>
