  ...
  return (
    <>
      <Helmet>
        ...
        <meta property="og:url" content={`https://portail-electricite.com/raccordement-electrique-${slug}`} />
        <link rel="canonical" href={`https://portail-electricite.com/raccordement-electrique-${slug}`} />
        ...
        <script type="application/ld+json">{`
          {
            ...
            "itemListElement": [
              ...
              },
              {
                ...
                "item": "https://portail-electricite.com/raccordement-electrique-${slug}"
              }
            ]
          }
        `}</script>
        ...
        <script type="application/ld+json">{`
          {
            ...
            "url": "https://portail-electricite.com/raccordement-electrique-${slug}",
            "priceRange": "€€",
            "serviceArea": {
              "@type": "City",
              "name": "${name}"
