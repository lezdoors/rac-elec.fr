...
import { User, Building, LayoutDashboard, Home, Briefcase, LandPlot } from 'lucide-react';

type ClientType = 'particulier' | 'professionnel' | 'collectivite';

interface ModernClientTypeProps {
  value: string;
...
/**
 * Sélecteur de type client selon la maquette fournie
 * Version 6.0 - Implémentation exacte selon la capture d'écran voila.PNG
 */
export function ModernClientType({ value, onChange, error }: ModernClientTypeProps) {
        ...
        >
          <div className="flex p-3 items-center">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-gray-500">Raccordement électrique résidentiel</span>
            </div>
          </div>
        </div>
        ...
        >
          <div className="flex p-3 items-center">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-gray-500">Raccordement pour entreprises</span>
            </div>
          </div>
        </div>
        ...
        >
          <div className="flex p-3 items-center">
            ...
            <div className="flex flex-col">
              ...
              <span className="text-xs text-gray-500">Raccordement collectivités locales</span>
            </div>
          </div>
        </div>
      </div>
...
export default ModernClientType;